		...
		//else if($searchby=="") echo "<p class='lead' style='margin: 0px 0px 50px 100px;'> You left the <em>search by?</em> field empty! </p>";
			...
			else if(mysql_num_rows($temp)==1)
			{
				$row = mysql_fetch_assoc($temp);
                    ...
                    echo "<p class='lead' style='margin: 0px 0px 50px 100px;'> You searched for: $search </p>";
			...
			{	
		    	...
		    	for($i=0;$i<mysql_num_rows($temp);$i++)
		    	{
			    	...
			    	echo "<p class='lead' style='margin: 40px 0px 0px 100px;'> <a href='search.php? srch=$outname'> $outname </a> of branch $outbatch and Address: '$outadrs'.</p>";
			    	else 	
			    	echo "<p class='lead' style='margin: 40px 0px 0px 100px;'> <a href='search.php? srch=$outname'> $outname </a> of branch $outbatch and enrollment number $outenr.</p>";
		       }
		    }
		}
    }
